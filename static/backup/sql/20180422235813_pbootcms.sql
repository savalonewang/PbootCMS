...
('73','cn','0','中文','1','admin','admin','2017-11-30 13:55:37','2018-04-13 11:40:49');
...
('1','cn','长沙翱云网络科技有限公司','湖南长沙岳麓区雷锋大道609号','410000','谢先生','13988886666','0731-88886666','0731-88886666','admin@qq.com','88886666','/static/upload/image/2017120111492170805.jpg','91430102567650888G','');
...
('25','open_wap','0','1','255','手机版'),
('29','message_check_code','1','1','255','留言验证码'),
('30','smtp_server','smtp.qq.com','2','255','邮件SMTP服务器'),
('31','smtp_port','465','2','255','邮件SMTP端口'),
('32','smtp_ssl','1','1','255','邮件是否安全连接'),
('33','smtp_username','286545339@qq.com','2','255','邮件发送账号'),
('34','smtp_password','llurhhjspsgubhab','2','255','邮件发送密码'),
('35','admin_check_code','1','1','255','后台验证码'),
('36','weixin_appid','','2','255','微信APPID'),
('37','weixin_secret','','2','255','微信SECRET'),
('38','message_send_mail','0','1','255','留言发送邮件开关'),
('39','message_send_to','','1','255','留言发送到邮箱'),
('40','api_open','0','2','255','API开关'),
('41','api_auth','1','2','255','API强制认证'),
('42','api_appid','','2','255','API认证用户'),
('43','api_secret','','2','255','API认证密钥');
...
INSERT INTO `ay_extfield` (`id`,`mcode`,`name`,`type`,`value`,`description`) VALUES
('1','3','ext_price','1','','产品价格');
...
CREATE TABLE `ay_label` (
  ...
  `type` char(1) NOT NULL DEFAULT '1' COMMENT '字段类型1文本2时间3图片4附件5编辑器',
...
INSERT INTO `ay_link` (`id`,`acode`,`gid`,`name`,`link`,`logo`,`create_user`,`update_user`,`create_time`,`update_time`) VALUES
('1','cn','1','PbootCMS','http://www.pbootcms.com','/static/upload/image/20180412/1523501605180536.png','admin','admin','2018-04-12 10:53:06','2018-04-12 10:53:26');
...
('1','M101','0','系统管理','/admin/M101/index','100','1','0','','admin','admin','0000-00-00 00:00:00','2018-04-07 18:42:29'),
('36','M111','M110','站点信息','/admin/Site/index','301','1','1','fa-cog','admin','admin','0000-00-00 00:00:00','2018-04-07 18:45:57'),
('37','M103','M101','系统菜单','/admin/Menu/index','102','1','0','fa-bars','admin','admin','0000-00-00 00:00:00','2018-04-07 18:42:47'),
('38','M102','M101','数据区域','/admin/Area/index','101','1','1','fa-sitemap','admin','admin','0000-00-00 00:00:00','2018-04-07 18:42:40'),
('46','M104','M101','系统角色','/admin/Role/index','103','1','1','fa-hand-stop-o','admin','admin','0000-00-00 00:00:00','2018-04-07 18:42:54'),
('51','M105','M101','系统用户','/admin/User/index','104','1','1','fa-users','admin','admin','0000-00-00 00:00:00','2018-04-07 18:43:01'),
('52','M106','M101','系统日志','/admin/Syslog/index','105','1','1','fa-history','admin','admin','0000-00-00 00:00:00','2018-04-07 18:43:12'),
('53','M112','M110','公司信息','/admin/Company/index','302','1','1','fa-copyright','admin','admin','0000-00-00 00:00:00','2018-04-07 18:46:09'),
('56','M107','M101','类型管理','/admin/Type/index','106','0','1','fa-tags','admin','admin','0000-00-00 00:00:00','2018-04-07 18:43:21'),
('72','M109','M101','服务器信息','/admin/Site/server','108','1','1','fa-info-circle','admin','admin','0000-00-00 00:00:00','2018-04-08 21:42:00'),
('75','M108','M101','数据库管理','/admin/Database/index','107','1','1','fa-database','admin','admin','0000-00-00 00:00:00','2018-04-07 18:43:28'),
('121','M110','0','基础内容','/admin/M112/index','300','1','0','','admin','admin','2017-11-28 11:13:05','2018-04-07 18:45:07'),
('138','M129','M110','内容栏目','/admin/ContentSort/index','303','1','1','fa-bars','admin','admin','2017-12-26 10:42:40','2018-04-07 18:46:25'),
('139','M130','0','文章内容','/admin/M130/index','400','1','0','','admin','admin','2017-12-26 10:45:36','2018-04-07 18:45:33'),
...
('165','M154','M156','邮件配置','/admin/Config/email','202','1','1','fa-envelope-o','admin','admin','2018-03-24 00:06:30','2018-04-07 18:44:19'),
('166','M155','M156','模型管理','/admin/Model/index','204','1','1','fa-codepen','admin','admin','2018-03-25 17:16:06','2018-04-07 18:44:40'),
('167','M156','0','全局配置','/admin/M156/index','200','1','0','','admin','admin','2018-03-25 17:20:43','2018-04-07 18:43:47'),
('168','M157','0','扩展内容','/admin/M157/index','500','1','0','','admin','admin','2018-03-25 17:27:57','2018-04-07 18:45:43'),
...
('1','cn','星梦','18711096563','PbootCMS真心很不错哦！','2130706433','Windows 10','Firefox','谢谢您对我们的大力支持与肯定！','1','admin','admin','2018-04-12 10:56:09','2018-04-12 10:56:42');
...
CREATE TABLE `ay_site` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '站点编号',
  `acode` varchar(20) NOT NULL COMMENT '区域代码',
  `title` varchar(30) NOT NULL COMMENT '站点标题',
  `subtitle` varchar(50) NOT NULL COMMENT '站点副标题',
...
('1','cn','PbootCMS','开源企业网站开发建设管理系统','www.pbootcms.com','/static/upload/image/2017120100155179053.jpg','PHP,ASP,Pboot,CMS,PHPCMS,PbootCMS,ASPCMS,免费开源,网站建设,网站开发,网站设计,网站管理,管理系统,网站源码','PbootCMS是翱云科技开发的全新内核的开源企业建站系统，系统以更优、更快、更便捷为开发目标，能够满足各类企业网站建设的需要；采用高效、简洁的模板标签，只要懂HTML就可快速开发企业网站；采用PHP语言开发，使用自主研发的高速MVVM多层开发框架及多级缓存技术；采用基于Bootstrap开发的响应式管理后台，满足各类设备随时管理的需要。','湘ICP备13009888号-1','default','','Copyright © 2018-2019 PbootCMS All Rights Reserved.');
...
CREATE TABLE `ay_slide` (
  ...
  `link` varchar(100) NOT NULL COMMENT '跳转链接',
  `title` varchar(30) NOT NULL COMMENT '说明文字',
  `create_user` varchar(30) NOT NULL COMMENT '创建人员',
  `update_user` varchar(30) NOT NULL COMMENT '更新人员',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '修改时间',
...
INSERT INTO `ay_slide` (`id`,`acode`,`gid`,`pic`,`link`,`title`,`create_user`,`update_user`,`create_time`,`update_time`) VALUES
('1','cn','1','/static/upload/image/20180412/1523500997605565.jpg','http://www.pbootcms.com','首页背景图','admin','admin','2018-03-01 16:19:03','2018-04-12 10:43:19'),
('7','cn','1','/static/upload/image/20180412/1523501147676550.jpg','http://www.pbootcms.com','首页背景图','admin','admin','2018-04-12 10:46:07','2018-04-12 10:46:07'),
('8','cn','1','/static/upload/image/20180412/1523501459462835.jpg','http://www.pbootcms.com','首页背景图','admin','admin','2018-04-12 10:51:12','2018-04-12 10:51:19');
...
('1','10001','admin','超级管理员','14e1b600b1fd579f47433b88e8d85291','1','1337','2130706433','admin','admin','2017-05-08 18:50:30','2018-04-13 15:14:58'),
('40','10002','hnxsh','星梦','6a316919d47c67756f296786c5a3fcfc','1','1','2130706433','admin','admin','2018-04-09 13:34:52','2018-04-09 13:35:11');
